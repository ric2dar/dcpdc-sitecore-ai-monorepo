...
export async function GET() {
  const description = `DCPDC Sitecore AI is a simple demo site showcasing component examples for Sitecore XM Cloud. It demonstrates modular UI patterns, layouts, and content-driven experiences built with Next.js App Router and the Content SDK. Ideal for exploring component variants and development best practices.`;

  const payload: SummaryJsonPayload = {
    title: 'DCPDC Sitecore AI',
